    ...
    <>
      <div className="min-h-screen bg-gray-50 text-gray-800">
        ...
        <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 flex justify-around py-3 z-50 shadow-lg">
          ...
          <Link href="/premium/vlogs" className="flex flex-col items-center text-xs text-gray-600">
            <ClipboardList className="w-6 h-6" />
          ...
          <Link href="/premium/tests" className="flex flex-col items-center text-xs text-gray-600">
            <ClipboardPenLine className="w-6 h-6" />
            <span className="mt-1">Tests</span>
          </Link>
          <Link href="/premium/certificates" className="flex flex-col items-center text-xs text-gray-600">
